...
void init()
{
	...
	rigidBodies.push_back(new RigidBodyModel(new Cat(vec3(-3.5f,1,0), quat(), vec3(1.5f, 1.0f, 2.0f)), shaders[currentShaderIndex+1], shaders[0]));
	...
	rigidBodies.push_back(new RigidBodyModel(new Plane(vec3(0,0,0), quat(), vec2(5.0f, 5.0f)), shaders[currentShaderIndex], shaders[0]));
