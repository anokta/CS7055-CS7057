...
void AudioManager::LoadResources() {
	...
	AddMusic("Song 1", "..\\IET\\res\\over.mp3", true);
	AddMusic("Song 2", "..\\IET\\res\\insistent.mp3", true);
	AddMusic("Song 3", "..\\IET\\res\\Dare.mp3", true);
	AddMusic("Song 4", "..\\IET\\res\\rockstar.mp3", true);
	AddMusic("Song 5", "..\\IET\\res\\cider.mp3", true);
	AddMusic("Song 6", "..\\IET\\res\\sharamjey.mp3", true);
	AddMusic("Song 7", "..\\IET\\res\\sunday.mp3", true);
	AddMusic("Song 8", "..\\IET\\res\\lorem ipsum.mp3", true);
